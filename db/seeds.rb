...
#testsite = Custsite.create([{ www: 'testwebben.se' }, { active: 1 }])
#Liveaccess = Live.create([{ www: 'localhost' }, { ip: '127.0.0.1' }, { access: "1" }])
#Text = Pagetext.create([{ text: 'lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum'}])
